...
// oms App (with model-driven views for CRUD and Charts).
          ...
          <TopNav>
              <div className="evo-toolbar">
                  <ul role="nav" className="evo-nav-pills pull-left">
                      ...
                      <li><Link to="/insigma_roles/list" id="insigma_roles" className={entity==='insigma_roles'?'active':''}> Roles</Link></li>
                  </ul>
                  <div className="clearer"/>
              </div>
              <h2><Link to="/">OMS</Link></h2>
              <div className="clearer"/>
